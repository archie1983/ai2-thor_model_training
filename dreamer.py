...
# python3 dreamer.py --configs ai2thor --task ai2thor_nav --logdir ./logdir/ai2thor_nav_reward_test
# python3 dreamer.py --configs ai2thor --task ai2thor_nav --logdir ./logdir/ai2thor_nav_sparse_1234 --habitat_id 1234
